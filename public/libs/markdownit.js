 ...
 * ```javascript
 * // node.js, "classic" way:
 * var MarkdownIt = require('libs-it'),
 *     md = new MarkdownIt();
 * var result = md.render('# libs-it rulezz!');
 *
 * // node.js, the same, but with sugar:
 * var md = require('libs-it')();
 * var result = md.render('# libs-it rulezz!');
 *
 ...
 *
 * - ["commonmark"](https://github.com/libs-it/libs-it/blob/master/lib/presets/commonmark.js) -
 *   configures parser to strict [CommonMark](http://commonmark.org/) mode.
 * - [default](https://github.com/libs-it/libs-it/blob/master/lib/presets/default.js) -
 *   similar to GFM, used when no preset name given. Enables all available rules,
 *   but still without html, typographer & autolinker.
 * - ["zero"](https://github.com/libs-it/libs-it/blob/master/lib/presets/zero.js) -
 ...
 *   replacement](https://github.com/libs-it/libs-it/blob/master/lib/rules_core/replacements.js) +
 ...
 * ```javascript
 * // commonmark mode
 * var md = require('libs-it')('commonmark');
 *
 * // default mode
 * var md = require('libs-it')();
 *
...
function MarkdownIt(presetName, options) {
   ...
   * ```
   *
   * See [[Renderer]] docs and [source code](https://github.com/libs-it/libs-it/blob/master/lib/renderer.js).
   **/
   ...
   * [here](https://github.com/libs-it/libs-it/blob/master/lib/common/utils.js).
   **/
  this.utils = utils;
   ...
   * [here](https://github.com/libs-it/libs-it/blob/master/lib/helpers).
   **/
 ...
 * `libs-it` instance options on the fly. If you need multiple configurations
 ...
 * and data structure [here](https://github.com/libs-it/libs-it/tree/master/lib/presets)
 *
...
MarkdownIt.prototype.configure = function (presets) {
  ...
  if (utils.isString(presets)) {
    ...
    if (!presets) { throw new Error('Wrong `libs-it` preset "' + presetName + '", check name'); }
  }

  if (!presets) { throw new Error('Wrong `libs-it` preset, can\'t be empty'); }
 ...
 *
 * ```javascript
 * var iterator = require('libs-it-for-inline');
 * var md = require('libs-it')()
 ...
 * - env (Object): environment sandbox
 *
 * Render libs string into html. It does all magic for you :).
 *
...
function Renderer() {
   ...
   * ```
   *
   * See [source code](https://github.com/libs-it/libs-it/blob/master/lib/renderer.js)
